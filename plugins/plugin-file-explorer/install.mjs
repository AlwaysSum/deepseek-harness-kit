// Bootstrap installer for @dsh-kit/plugin-file-explorer into a dsh profile.
//
// Usage:
...
//
// Links the package into the profile's node_modules as a junction and records it
// in the profile manifest (dependencies + dsh.profile.bundles) so its bundle
// cordis.patch.yml mounts at boot.
...
const NAME = "@dsh-kit/plugin-file-explorer";
...
const linkPath = join(linkDir, "plugin-file-explorer");
...
console.log("重新启动 dsh 服务后，文件列表生效。");
